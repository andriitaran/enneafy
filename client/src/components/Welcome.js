    ...
    <section className="welcome">
      <div className="welcome-container">
        ...
        <span className="welcome-container__text">
          ...
          understanding ourselves and others. At its core, the Enneagram helps
          us to see ourselves at a deeper, more objective level and can be of
          invaluable assistance on our path to self-knowledge.
        </span>
        <a
        ...
        <Link to="/types">
          <button className="welcome-container__type">I KNOW MY TYPE!</button>
        </Link>
      </div>
    </section>
  );
